...
Se crea este repositorio para poder determinar las probabilidades de ganar la premier, clasificar a champions league y descensos, para de cada uno de los clubes de la premier league. Para tal fin, primero se crea una función que permita calcular los resultados posibles de los partidos (goles a favor, goles en contra, diferencia de goles, puntos y puesto), desde la fecha actual `r Sys.Date()`.
...
Asimismo, las imagenes que verán a continuación solo se irán actualizando cada vez que actualice el repositorio.
